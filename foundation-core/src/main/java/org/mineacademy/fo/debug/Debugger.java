...
public final class Debugger {
	 ...
	 * and printed.
	 */
	private static final Map<String, List<String>> pendingMessages = new LinkedHashMap<>();
	...
	public static void put(String section, String message) {
		...
		final List<String> list = pendingMessages.getOrDefault(section, new ArrayList<>());
		list.add(message);
