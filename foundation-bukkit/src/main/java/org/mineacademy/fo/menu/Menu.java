...
public abstract class Menu {
	 ...
	 */
	private final Map<Button, Position> registeredButtons = new LinkedHashMap<>();
	private final Map<Integer, Button> registeredButtonPositions = new LinkedHashMap<>();
	...
	final void registerButtons() {
		...
		// Register buttons explicitly given
		{
			...
			if (buttons != null) {
				final Map<Button, Position> buttonsRemapped = new LinkedHashMap<>();
