 ...
 */
class NMSDragon_v1_8Hack extends NMSDragon {

	private Object dragon;
	private int id;

	public NMSDragon_v1_8Hack(String name, Location loc) {
		super(name, loc);
	}
	...
	public Object getSpawnPacket() {
		...
		try {
			...
			final Field motX = ReflectionUtil.getField(Entity, "motX");
			motX.set(this.dragon, this.getXvel());

			final Field motY = ReflectionUtil.getField(Entity, "motY");
			motY.set(this.dragon, this.getYvel());

			final Field motZ = ReflectionUtil.getField(Entity, "motZ");
