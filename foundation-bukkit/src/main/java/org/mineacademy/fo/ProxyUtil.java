...
public final class ProxyUtil {
	 ...
	 */
	@SafeVarargs
	public static <T> void sendPluginMessageAs(@Nullable FoundationPlayer player, ProxyMessage message, T... datas) {
		sendPluginMessageAs((Player) player.getPlayer(), message, datas);
	}
